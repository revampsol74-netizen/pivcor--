...
<img src="./pivocr_logo.jpg" alt="PIVCOR Logo" width="300">
...
<details>
<summary><strong>Click to expand our Tech Stack</strong></summary>

* **AI & ML:** Python, TensorFlow, OpenAI API, LangChain
* **Blockchain:** Solidity, Solana (Rust), Web3.js, IPFS
* **Frontend/Mobile:** React.js, Next.js, React Native, Tailwind CSS, Framer Motion
* **Backend & Cloud:** Node.js, AWS (Lambda, EC2), Google Cloud, Firebase
* **CRM/Marketing:** Salesforce API, HubSpot API, Zapier, Mailchimp
